								...
								<ul class="navbar_user">
									...
									<li class="checkout">
										<a href="cart.php">
											...
											<span id="checkout_items" class="checkout_items"><?php
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							<?php
							$p->loadloai('select * from tbl_loai');
							?>
						</ul>
					</div>
						...
						<div class="row">
							<div class="col">
								...
								<div class="product-grid">
									...
									<!-- Product 1 -->
                                    <?php
									$layid_loai=$_REQUEST['Maloai'];
									if($layid_loai>0)
									{
										$p->loadsp("select * from tbl_sach where Maloai='$layid_loai'");
										}
									else
									{
									$p->loadsp('select * from tbl_sach');
									}
