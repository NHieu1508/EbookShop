...
if($MaKHsua>0)
{
if($p->themxoasua("UPDATE tbl_khachhang SET Hoten = '$Hoten',Diachi = '$Diachi',Sdt = '$Sdt',Email='$Email',Password= '$Password' WHERE MaKH = '$MaKHsua' LIMIT 1 ")==1)
{
...
{
  echo '<p style="color:green; font-size:1.6rem;text-align:center;"><strong>Vui lòng chọn khách hàng cần sửa</strong></p>';
}
break;
}
    }
